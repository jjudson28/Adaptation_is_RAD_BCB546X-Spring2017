...
allfoxplot <- ggplot(gf_pc_scores) + geom_point(aes(x = PC1, y = PC3, colour = pops_grey)) + coord_equal() + ggtitle("PCA Plot with Island Populations and Grey Fox") + labs(x = "PC1(18.3%)", y = "PC3(35.3%)") #plot function with ggplot 2 
...
nogreyplot <- ggplot(ngf_pc_scores) + geom_point(aes(x = PC1, y = PC3, colour = pops_ng)) + coord_equal() + ggtitle("PCA Plot with Island Populations") + labs(x = "PC1(21.1%)", y = "PC3(39.9%)") #plotting function with ggplot2
